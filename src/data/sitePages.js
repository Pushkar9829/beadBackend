  ...
  customize: {
    steps: [
      ...
      },
      {
        ...
        title: 'Choose sub-intentions',
        body: 'Pick up to three. Each has a named bracelet. Keep 3 to 5 crystals, then continue.',
      },
      {
        eyebrow: 'Step 03 · Bead size',
        title: 'Bead size',
        body: '6mm, 8mm or 10mm. Count follows wrist size.',
      },
      {
        eyebrow: 'Step 04 · Wrist',
        title: 'Wrist size',
        body: 'Needed for strand count. Elastic still wears as a free-size fit.',
      },
      {
        eyebrow: 'Step 05 · Design',
        title: 'Charm, CZ & thread',
        body: 'Sriyantra or Om, CZ or round CZ, Korean elastic or steel core.',
      },
      {
        eyebrow: 'Step 06 · Personalise',
        title: 'Personalise',
        body: 'Optional name or short dedication.',
      },
      {
